...
import { Box, Button, Checkbox, IconButton, Toolbar, Tooltip, Typography, alpha } from "@mui/material";
            ...
            {data ? (
              <TableBody>
                {data.map((row) => {
                  ...
                  return (
                    <StyledTableRow key={row._id} onClick={(event) => handleClick(event, row._id)}>
                      <StyledTableCell align='left'>
                        <Checkbox
                          color='primary'
                          sx={{
